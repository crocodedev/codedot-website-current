...
const Contact = ({ className, frontmatter, langKey }) => {
  ...
  const balloon = `
    ...
    <div class='contact-info'>
      <div class='d-flex'>
        <svg aria-hidden='true' focusable='false' data-prefix='fab' data-icon='skype' class='svg-inline--fa fa-skype fa-w-14 me-2' role='img' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512'>
      ...
      <div class='d-flex'>
        <svg aria-hidden='true' focusable='false' data-prefix='fab' data-icon='telegram-plane' class='svg-inline--fa fa-telegram-plane fa-w-14 me-2' role='img' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512'>
      ...
      <div class='d-flex'>
        <svg aria-hidden='true' focusable='false' data-prefix='fas' data-icon='envelope' class='svg-inline--fa fa-envelope fa-w-16 me-2' role='img' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'>
      ...
      <div class='d-flex'>
        <svg aria-hidden='true' focusable='false' data-prefix='fas' data-icon='building' class='svg-inline--fa fa-building fa-w-14 me-2' role='img' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512'>
