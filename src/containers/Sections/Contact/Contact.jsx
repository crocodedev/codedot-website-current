...
const Contact = ({ className, frontmatter, mapCenter }) => {
      ...
      <div className='contact-map' ref={ref}>
        {hasMounted && (
          ...
          >
            ...
            <Marker latitude={viewport.latitude} longitude={viewport.longitude} offsetLeft={-40}
                    offsetTop={-80}>
              <svg
                ...
                <div className='contact-info'>
                  <div className='contact-body'>
                    ...
                    <div className='d-flex'>
                      ...
                      <a className='custom-link' href={`skype:${skype}?chat`}>{skype}</a>
                    </div>
                    <div className='d-flex'>
                      <svg
                        aria-hidden='true'
                      ...
                      <a className='custom-link'
                         href={`tg://resolve?domain=:${telegram}`}>@{telegram}</a>
                    </div>
                    <div className='d-flex'>
                      <svg
                        aria-hidden='true'
                      ...
                      <a className='custom-link' href={`mailto:${email}`}>{email}</a>
                    </div>
                    <div className='d-flex'>
                      <svg
                        aria-hidden='true'
